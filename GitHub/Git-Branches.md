...
I had 2 branches: one is "master," and the other is "addReadme." Initially, in my code, I only had a clock showing up in the "master" branch, and in the "addReadme" branch, I added one more file named "readme.md."
...
- Let's say I want to add date functionality to the project. I create a new branch called "new-feature" and make a commit to add the date functionality.
